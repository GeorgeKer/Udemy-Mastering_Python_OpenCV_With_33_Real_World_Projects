...
* Project 24 : Detect and Recognize Car License Plate from a video in real time
* Project 25: Right and Left Hand Detection Using Python
* Project 26 : control your mouse using openCV
* Project 27 : Real-Time Face Mesh Detection with Python, OpenCV & MediaPipe!
* Project 28: Real-Time Face Tilt Detection (Webcam + MediaPipe)
* Project 29: Create a Screen recorder using Python
* Project 30 : Build a real-time multi-face recognizer
* Project 31: Gesture-Controlled Webcam Filters using OpenCV & MediaPipe
* Project 32 : how to create Barcode scanner with the help of openCV
* Project 33 : Real-Time Face Swapping Using OpenCV & MediaPipe
